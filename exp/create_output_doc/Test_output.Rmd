...
if (params$cgmlst == TRUE){
  ...
  # Produce empty df:s
  k1 <- data.frame(Date=as.Date(character()),
                 File=character(), 
                 User=character(), 
...
if (dim(k1)[1] != 0 & dim(k1)[2] != 0) {
  ...
  cat("No cgmlst results due to missing schema in: https://www.cgmlst.org/ncs \n or http://enterobase.warwick.ac.uk/")
}
