...
read_tsv("aMRFinderPlus.tsv") %>%
    ...
    style = 'caption-side: bottom; text-align: center;',
    'Table 6: AMRFinderPlus results. For more information on them, see: ', htmltools::tags$a(href="https://github.com/ncbi/amr/wiki/Interpreting-results", "AMR - Interpreting results"), '.')
    )
```
...
t(k7d) %>%
  datatable(
    ...
    style = 'caption-side: bottom; text-align: center;',
    'Table 7: Output of genome assembly quality assessment tool. For detailed information on the table headers, see: ', htmltools::tags$a(href="http://quast.sourceforge.net/docs/manual.html#sec3.1.1", "QUAST manual"))
    )
```
