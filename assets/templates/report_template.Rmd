...
if (dim(k8d)[1] != 0 & dim(k8d)[2] != 0) {
  k8d %>% 
    dt_alise('Table 9: SNP analysis: ', htmltools::tags$a(href="", ""))
}else{
  # If not found, print out just a plain and simple text
  cat("No found SNPs")
}
...
read_tsv(params$spa_path) %>% 
  ...
  style = 'caption-side: bottom; text-align: center;',
  'Table 10: Output of spaTyper tool: ', htmltools::tags$a(href="https://github.com/HCGB-IGTP/spaTyper", "https://github.com/HCGB-IGTP/spaTyper"))
)
```
